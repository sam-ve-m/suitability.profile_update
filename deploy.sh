fission spec init
fission env create --spec --name acc-suit-quest-update-env --image nexus.sigame.com.br/fission-account-suit-quest-update:0.1.0 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
